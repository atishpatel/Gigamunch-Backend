<template>
  ...
  >
    <template v-slot:dialog-content>
      <v-card-text>Refund <span class="bold">{{activity.first_name}} {{activity.last_name}}</span> for <span class="bold">{{activity.dateFull}}</span>?</v-card-text>
      <v-layout>
        <v-flex>
          <v-text-field
...
import { RefundActivity } from '../ts/service';
