...
func (service *Service) SetupSubLogs(ctx context.Context, req *DateReq) (*ErrorOnlyResp, error) {
	...
	log, serverInfo, err := setupLoggingAndServerInfo(ctx, "/cookapi/setupsublogs")
	if err != nil {
		resp.Err = errors.GetErrorWithCode(err)
		return resp, nil
	}
	subC, err := subnew.NewClient(ctx, log, nil, nil, serverInfo)
...
func (service *Service) ProcessSubLog(ctx context.Context, req *SubLogReq) (*ErrorOnlyResp, error) {
	...
	log, serverInfo, err := setupLoggingAndServerInfo(ctx, "/cookapi/processsublogs")
	if err != nil {
		resp.Err = errors.GetErrorWithCode(err)
		return resp, nil
	}
	activityC, err := activity.NewClient(ctx, log, nil, nil, serverInfo)
...
func (service *Service) SkipSubLog(ctx context.Context, req *SubLogReq) (*ErrorOnlyResp, error) {
	...
	log, serverInfo, err := setupLoggingAndServerInfo(ctx, "/cookapi/skipsublogs")
	if err != nil {
		resp.Err = errors.GetErrorWithCode(err)
		return resp, nil
	}
...
func (service *Service) RefundAndSkipSubLog(ctx context.Context, req *SubLogReq) (*ErrorOnlyResp, error) {
	...
	log, serverInfo, err := setupLoggingAndServerInfo(ctx, "/cookapi/refundandskipsublog")
	if err != nil {
		resp.Err = errors.GetErrorWithCode(err)
		return resp, nil
	}
